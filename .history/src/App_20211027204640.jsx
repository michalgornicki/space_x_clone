          ...
          <div className="rescue-ships">
            ...
            <div className="ship-container">
              {launches[launchnumber].ships[0] ? (
                ...
                <div className="row"><div className="header-content-slide">HOME PORT <div className="header-content-slide-text">{launches[launchnumber].ships[0].home_port} </div> </div></div>
                <div className="row"><div className="header-content-slide">WEIGHT [KG] <div className="header-content-slide-text"></div> </div></div>
              </div>
              ) : (
              ...
              {launches[launchnumber].ships[1] ? (
                ...
                <img
                  ...
                  alt=""
                />
                <div className="header-slide">{launches[launchnumber].ships[1].name}</div>
                <div className="row"><div className="header-content-slide">HOME PORT <div className="header-content-slide-text">{launches[launchnumber].ships[1].home_port} </div> </div></div>
                <div className="row"><div className="header-content-slide">WEIGHT [KG] <div className="header-content-slide-text"></div> </div></div>
              </div>
              ) : (
                ""
              ...
              {launches[launchnumber].ships[2] ? (
                ...
                <img
                  ...
                  alt=""
                />
                <div className="header-slide">{launches[launchnumber].ships[2].name}</div>
                <div className="header-content-slide">HOME PORT <div className="header-content-slide-text">{launches[launchnumber].ships[2].home_port} </div> </div>
                <div className="header-content-slide">WEIGHT [KG] <div className="header-content-slide-text"></div> </div>
              </div>
              ) : (
                ""
              )}
              ...
              {launches[launchnumber].ships[3] ? (
                ...
                <img
                  ...
                  alt=""
                />
                <div className="header-slide">{launches[launchnumber].ships[3].name}</div>
                <div className="header-content-slide">HOME PORT <div className="header-content-slide-text">{launches[launchnumber].ships[3].home_port} </div> </div>
                <div className="header-content-slide">WEIGHT [KG] <div className="header-content-slide-text"></div> </div>
              </div>
              ) : (
                ""
