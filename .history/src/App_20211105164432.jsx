...
">{launches[launchnumber].rocket.rocket_name}</abbr>
          ...
          {launches[launchnumber].links.flickr_images[1] ? <img className="launch-image" src={launches[launchnumber].links.flickr_images[1]} alt="" /> : "" }
          {launches[launchnumber].links.flickr_images[2] ? <img className="launch-image" src={launches[launchnumber].links.flickr_images[2]} alt="" /> : "" }
            
          <img className="launch-image" src={launches[launchnumber].links.flickr_images[0]} alt="" />
          <img className="launch-image" src={launches[launchnumber].links.flickr_images[1]} alt="" />
          <img className="launch-image" src={launches[launchnumber].links.flickr_images[2]} alt="" />
