          ...
          <div className="rescue-ships">
            ...
            <div className="ship-container">
              ...
              {launches[launchnumber].ships[1] ? (
                ...
                <div><div className="header-content-slide">HOME PORT <div className="header-content-slide-text">{launches[launchnumber].ships[1].home_port} </div> </div></div>
                <div><div className="header-content-slide">WEIGHT [KG] <div className="header-content-slide-text"></div> </div></div>
              </div>
              ) : (
                ""
              )}
