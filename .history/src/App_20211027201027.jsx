              ...
              {launches[launchnumber].ships[0] ? (
                <div className="ship-slide">
                  <img
                    ...
                    alt=""
                  />
                  <div className="header">{launches[launchnumber].ships[0].name}</div>
                  <div className="header-content">HOME PORT {launches[launchnumber].ships[0].home_port}</div>
                  <div className="header-content">WEIGHT [KG]</div>
                </div>
              ) : (
