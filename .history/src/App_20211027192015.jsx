...
<div className="rescue-ships">
  ...
  <div className="ship-container">
    <div className="ship-slide">
      <img class="ship-image" src={launches[launchnumber].ships[0].image} alt="" />
      <div className="header"></div>
      <div className="header-content"></div>
      <div className="header-content"></div>
    </div>
    <div className="ship-slide">
      <img class="ship-image" src={launches[launchnumber].ships[1].image} alt="" />
      <div className="header"></div>
      <div className="header-content"></div>
      <div className="header-content"></div>
    </div>
    <div className="ship-slide">
      <img class="ship-image" src={launches[launchnumber].ships[2].image} alt="" />
      <div className="header"></div>
      <div className="header-content"></div>
      <div className="header-content"></div>
    </div>
