                ...
                <div className="ship-slide">
                  ...
                  <div className="row">
                    <div className="header-content-slide">
                      WEIGHT [KG]
                      <div className="header-content-slide-text">
                        {launches[launchnumber].ships[0].weight_kg? launches[launchnumber].ships[0].weight_kg : "unknown"}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="ship-slide">
                  ...
                  <div className="row">
                    <div className="header-content-slide">
                      WEIGHT [KG]
                      <div className="header-content-slide-text">
                      {launches[launchnumber].ships[1].weight_kg? launches[launchnumber].ships[1].weight_kg : "unknown"}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="ship-slide">
                  ...
                  <div className="row">
                    <div className="header-content-slide">
                      WEIGHT [KG]
                      <div className="header-content-slide-text">
                      {launches[launchnumber].ships[2].weight_kg? launches[launchnumber].ships[2].weight_kg : "unknown"}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="ship-slide">
                  ...
                  <div className="row">
                    <div className="header-content-slide">
                      WEIGHT [KG]
                      <div className="header-content-slide-text">
                      {launches[launchnumber].ships[3].weight_kg? launches[launchnumber].ships[3].weight_kg : "unknown"}
                      </div>
                    </div>
                  </div>
                </div>
